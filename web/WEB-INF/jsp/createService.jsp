...
<div class="container">
    ...
    <form action="/fund/createService" method="post">
        ...
        <div class="form-group">
            <label>最大个数</label>
            <input type="text" class="form-control" name="maxSeq" required>
        </div>
        <div class="form-group">
            <label>系统名称</label>
            <input type="text" class="form-control" name="seqName" required>
        </div>
